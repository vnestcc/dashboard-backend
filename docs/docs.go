    ...
    "paths": {
        ...
        "/manage/company/quarters/new": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Quarter and Year to allow",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/company.nextQuarter"
                        }
                    }
                ],
                "responses": {
        ...
        "/manage/company/quarters/remove": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/manage/company/quarters/{id}/new": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/manage/company/quarters/{id}/remove": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
